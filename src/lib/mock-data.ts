...
export const mockSlots = [
  // ==========================================
  // DAY 1 MORNING — 主论坛 (Main Hall only)
  // ==========================================
  { id: "d1-1", date: "2027-04-26", start_time: "08:30", end_time: "09:00", label: "Registration & Welcome", label_zh: "签到 & 入场", type: "opening", room: "Main Hall", sort_order: 1, session_id: null, sessions: null },
  { id: "d1-2", date: "2027-04-26", start_time: "09:00", end_time: "09:15", label: "Opening Ceremony", label_zh: "开幕致辞", type: "opening", room: "Main Hall", sort_order: 2, session_id: null, sessions: null },
  { id: "d1-3", date: "2027-04-26", start_time: "09:15", end_time: "10:00", label: "", label_zh: "", type: "keynote", room: "Main Hall", sort_order: 3, session_id: "s-k1",
  ...
  { id: "d1-4", date: "2027-04-26", start_time: "10:00", end_time: "10:45", label: "", label_zh: "", type: "keynote", room: "Main Hall", sort_order: 4, session_id: "s-k2",
  ...
  { id: "d1-5", date: "2027-04-26", start_time: "10:45", end_time: "11:15", label: "Coffee Break & Networking", label_zh: "茶歇 & 交流", type: "break", room: null, sort_order: 5, session_id: null, sessions: null },
  { id: "d1-6", date: "2027-04-26", start_time: "11:15", end_time: "12:00", label: "", label_zh: "", type: "keynote", room: "Main Hall", sort_order: 6, session_id: "s-k3",
  ...
  { id: "d1-7", date: "2027-04-26", start_time: "12:00", end_time: "13:30", label: "Lunch Break", label_zh: "午餐", type: "break", room: null, sort_order: 7, session_id: null, sessions: null },

  // ==========================================
  // DAY 1 AFTERNOON — 分论坛 (4 parallel rooms)
  // ==========================================
  // — Room A: 数据库内核 —
  { id: "d1p-1a", date: "2027-04-26", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 10, session_id: "s-p1",
  ...
  { id: "d1p-2a", date: "2027-04-26", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 11, session_id: "s-p2",
  ...
  { id: "d1p-3a", date: "2027-04-26", start_time: "15:30", end_time: "16:15", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 12, session_id: null, sessions: null },
  { id: "d1p-4a", date: "2027-04-26", start_time: "16:30", end_time: "17:15", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 13, session_id: null, sessions: null },

  // — Room B: 性能与运维 —
  { id: "d1p-1b", date: "2027-04-26", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 20, session_id: "s-p5",
  ...
  { id: "d1p-2b", date: "2027-04-26", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 21, session_id: "s-p6",
  ...
  { id: "d1p-3b", date: "2027-04-26", start_time: "15:30", end_time: "16:15", label: "Workshop: PGAdmin Deep Dive", label_zh: "动手实践：PGAdmin 深度使用", type: "workshop", room: "Room B — 性能与运维", sort_order: 22, session_id: null, sessions: null },
  { id: "d1p-4b", date: "2027-04-26", start_time: "16:30", end_time: "17:15", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 23, session_id: null, sessions: null },

  // — Room C: 扩展与生态 —
  { id: "d1p-1c", date: "2027-04-26", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 30, session_id: "s-p9",
  ...
  { id: "d1p-2c", date: "2027-04-26", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 31, session_id: "s-p10",
  ...
  { id: "d1p-3c", date: "2027-04-26", start_time: "15:30", end_time: "16:15", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 32, session_id: null, sessions: null },
  { id: "d1p-4c", date: "2027-04-26", start_time: "16:30", end_time: "17:15", label: "Panel: The Future of PG Extensions", label_zh: "圆桌：PG 扩展的未来", type: "panel", room: "Room C — 扩展与生态", sort_order: 33, session_id: null, sessions: null },

  // — Room D: 应用与案例 —
  { id: "d1p-1d", date: "2027-04-26", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 40, session_id: "s-p13",
  ...
  { id: "d1p-2d", date: "2027-04-26", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 41, session_id: "s-p14",
  ...
  { id: "d1p-3d", date: "2027-04-26", start_time: "15:30", end_time: "16:15", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 42, session_id: null, sessions: null },
  { id: "d1p-4d", date: "2027-04-26", start_time: "16:30", end_time: "17:15", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 43, session_id: null, sessions: null },

  // ==========================================
  // DAY 2 MORNING — 分论坛 (4 rooms)
  // ==========================================
  { id: "d2m-1a", date: "2027-04-27", start_time: "09:00", end_time: "09:45", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 1, session_id: null, sessions: null },
  { id: "d2m-2a", date: "2027-04-27", start_time: "10:00", end_time: "10:45", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 2, session_id: "s-d2-2",
    sessions: { id: "s-d2-2", title: "Understanding PostgreSQL MVCC Internals", title_zh: "理解 PostgreSQL MVCC 内部机制", abstract: "MVCC is the foundation of PostgreSQL's concurrency model. We walk through tuple visibility, snapshot management, vacuum internals, and how to diagnose and fix common MVCC-related performance issues.", abstract_zh: "MVCC 是 PostgreSQL 并发模型的基础。我们介绍元组可见性、快照管理、Vacuum 内部机制，以及如何诊断和修复常见的 MVCC 相关性能问题。", duration: 45, type: "talk",
      profiles: { full_name: "Zhang Wei", company: "IvorySQL", bio: "Core contributor to PostgreSQL and founder of the IvorySQL project. 15+ years in database kernel development.", bio_zh: "PostgreSQL 核心贡献者，IvorySQL 项目创始人。15年以上数据库内核开发经验。", photo_url: photo("Zhang Wei") } } },
  { id: "d2m-3a", date: "2027-04-27", start_time: "11:00", end_time: "11:45", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 3, session_id: null, sessions: null },
  { id: "d2m-4a", date: "2027-04-27", start_time: "12:00", end_time: "13:30", label: "Lunch Break", label_zh: "午餐", type: "break", room: null, sort_order: 99, session_id: null, sessions: null },

  { id: "d2m-1b", date: "2027-04-27", start_time: "09:00", end_time: "09:45", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 10, session_id: "s-d2b1",
    sessions: { id: "s-d2b1", title: "Connection Pooling: PgBouncer vs Odyssey", title_zh: "连接池：PgBouncer vs Odyssey", abstract: "Choosing the right connection pooler is critical for PostgreSQL at scale. We benchmark PgBouncer and Odyssey across transaction throughput, memory usage, and failover behavior under production-like workloads.", abstract_zh: "选择合适的连接池对大规模 PostgreSQL 至关重要。我们在类似生产的负载下对 PgBouncer 和 Odyssey 进行事务吞吐量、内存使用和故障转移行为的基准测试。", duration: 45, type: "talk",
      profiles: { full_name: "Alex Johnson", company: "GitLab", bio: "Staff database engineer at GitLab, maintaining one of the world's largest PostgreSQL fleets.", bio_zh: "GitLab 高级数据库工程师，维护全球最大的 PostgreSQL 集群之一。", photo_url: photo("Alex Johnson") } } },
  { id: "d2m-2b", date: "2027-04-27", start_time: "10:00", end_time: "10:45", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 11, session_id: null, sessions: null },
  { id: "d2m-3b", date: "2027-04-27", start_time: "11:00", end_time: "11:45", label: "Workshop: Disaster Recovery Drill", label_zh: "动手实践：灾难恢复演练", type: "workshop", room: "Room B — 性能与运维", sort_order: 12, session_id: null, sessions: null },
  { id: "d2m-4b", date: "2027-04-27", start_time: "12:00", end_time: "13:30", label: "Lunch Break", label_zh: "午餐", type: "break", room: null, sort_order: 99, session_id: null, sessions: null },

  { id: "d2m-1c", date: "2027-04-27", start_time: "09:00", end_time: "09:45", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 20, session_id: "s-d2c1",
  ...
  { id: "d2m-2c", date: "2027-04-27", start_time: "10:00", end_time: "10:45", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 21, session_id: null, sessions: null },
  { id: "d2m-3c", date: "2027-04-27", start_time: "11:00", end_time: "11:45", label: "Panel: Open Source Database Licensing", label_zh: "圆桌：开源数据库许可", type: "panel", room: "Room C — 扩展与生态", sort_order: 22, session_id: null, sessions: null },
  { id: "d2m-4c", date: "2027-04-27", start_time: "12:00", end_time: "13:30", label: "Lunch Break", label_zh: "午餐", type: "break", room: null, sort_order: 99, session_id: null, sessions: null },

  { id: "d2m-1d", date: "2027-04-27", start_time: "09:00", end_time: "09:45", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 30, session_id: "s-d2d1",
  ...
  { id: "d2m-2d", date: "2027-04-27", start_time: "10:00", end_time: "10:45", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 31, session_id: null, sessions: null },
  { id: "d2m-3d", date: "2027-04-27", start_time: "11:00", end_time: "11:45", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 32, session_id: null, sessions: null },
  { id: "d2m-4d", date: "2027-04-27", start_time: "12:00", end_time: "13:30", label: "Lunch Break", label_zh: "午餐", type: "break", room: null, sort_order: 99, session_id: null, sessions: null },

  // ==========================================
  // DAY 2 AFTERNOON — 分论坛 (4 rooms)
  // ==========================================
  { id: "d2pm-1a", date: "2027-04-27", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 50, session_id: null, sessions: null },
  { id: "d2pm-2a", date: "2027-04-27", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 51, session_id: null, sessions: null },
  { id: "d2pm-3a", date: "2027-04-27", start_time: "15:30", end_time: "16:15", label: "", label_zh: "", type: "session", room: "Room A — 数据库内核", sort_order: 52, session_id: null, sessions: null },
  { id: "d2pm-4a", date: "2027-04-27", start_time: "16:30", end_time: "17:00", label: "Closing & Lucky Draw", label_zh: "闭幕 & 抽奖", type: "closing", room: "Main Hall", sort_order: 90, session_id: null, sessions: null },

  { id: "d2pm-1b", date: "2027-04-27", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 60, session_id: null, sessions: null },
  { id: "d2pm-2b", date: "2027-04-27", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 61, session_id: null, sessions: null },
  { id: "d2pm-3b", date: "2027-04-27", start_time: "15:30", end_time: "16:15", label: "", label_zh: "", type: "session", room: "Room B — 性能与运维", sort_order: 62, session_id: null, sessions: null },
  { id: "d2pm-4b", date: "2027-04-27", start_time: "16:30", end_time: "17:00", label: "Closing & Lucky Draw", label_zh: "闭幕 & 抽奖", type: "closing", room: "Main Hall", sort_order: 90, session_id: null, sessions: null },

  { id: "d2pm-1c", date: "2027-04-27", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 70, session_id: null, sessions: null },
  { id: "d2pm-2c", date: "2027-04-27", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 71, session_id: null, sessions: null },
  { id: "d2pm-3c", date: "2027-04-27", start_time: "15:30", end_time: "16:15", label: "", label_zh: "", type: "session", room: "Room C — 扩展与生态", sort_order: 72, session_id: null, sessions: null },
  { id: "d2pm-4c", date: "2027-04-27", start_time: "16:30", end_time: "17:00", label: "Closing & Lucky Draw", label_zh: "闭幕 & 抽奖", type: "closing", room: "Main Hall", sort_order: 90, session_id: null, sessions: null },

  { id: "d2pm-1d", date: "2027-04-27", start_time: "13:30", end_time: "14:15", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 80, session_id: null, sessions: null },
  { id: "d2pm-2d", date: "2027-04-27", start_time: "14:30", end_time: "15:15", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 81, session_id: "s-d2last",
  ...
  { id: "d2pm-3d", date: "2027-04-27", start_time: "15:30", end_time: "16:15", label: "", label_zh: "", type: "session", room: "Room D — 应用与案例", sort_order: 82, session_id: null, sessions: null },
  { id: "d2pm-4d", date: "2027-04-27", start_time: "16:30", end_time: "17:00", label: "Closing & Lucky Draw", label_zh: "闭幕 & 抽奖", type: "closing", room: "Main Hall", sort_order: 90, session_id: null, sessions: null },
]

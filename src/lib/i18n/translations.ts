...
export const admin = {
  ...
  day: { en: "Day", zh: "第" },
  daysuffix: { en: "", zh: "天" },
  slotsUnit: { en: "slots", zh: "个时段" },
  startTime: { en: "Start Time", zh: "开始时间" },
  endTime: { en: "End Time", zh: "结束时间" },
  addSlot: { en: "Add Slot", zh: "添加时段" },
  newSlot: { en: "New Agenda Slot", zh: "新建议程时段" },
  slotCreated: { en: "Slot created!", zh: "时段已创建！" },
  slotDeleted: { en: "Slot deleted", zh: "时段已删除" },
  assignSession: { en: "Assign session...", zh: "分配演讲..." },
  noSession: { en: "(No session)", zh: "（无演讲）" },
  sessionAssigned: { en: "Session assigned", zh: "演讲已分配" },
  sessionUnassigned: { en: "Session unassigned", zh: "已取消分配" },
  firstSlotCreated: { en: "First slot created!", zh: "首个时段已创建！" },
  noSlots: { en: "No agenda slots yet. Create your first day:", zh: "还没有议程时段。创建第一天：" },
  startBuilding: { en: "Start Building Agenda", zh: "开始构建议程" },
  typeEn: { en: "EN", zh: "英文" },
  typeZh: { en: "中文", zh: "中文" },
  titleEn: { en: "Title (EN)", zh: "标题（英文）" },
  titleZh: { en: "Title (中文)", zh: "标题（中文）" },
  room: { en: "Room", zh: "会场" },
  // Admin sponsors
  addSponsor: { en: "Add Sponsor", zh: "添加赞助商" },
  editSponsor: { en: "Edit Sponsor", zh: "编辑赞助商" },
  sponsorAdded: { en: "Sponsor added!", zh: "赞助商添加成功！" },
  sponsorUpdated: { en: "Sponsor updated!", zh: "赞助商更新成功！" },
  sponsorRemoved: { en: "Sponsor removed", zh: "赞助商已删除" },
  noSponsors: { en: "No sponsors yet. Add your first sponsor!", zh: "还没有赞助商。添加第一个吧！" },
  logo: { en: "Logo", zh: "Logo" },
  preview: { en: "Preview", zh: "预览" },
  // Admin updates
  newPost: { en: "New Post", zh: "新建动态" },
  editPost: { en: "Edit Post", zh: "编辑动态" },
  postPublished: { en: "Post published!", zh: "动态已发布！" },
  postUpdated: { en: "Post updated!", zh: "动态已更新！" },
  postDeleted: { en: "Post deleted", zh: "动态已删除" },
  noUpdates: { en: "No updates yet. Create your first post!", zh: "还没有动态。创建第一篇文章吧！" },
  publish: { en: "Publish", zh: "发布" },
  // Admin checkin
  checkinTitle: { en: "Check-In", zh: "签到" },
  undoLabel: { en: "Undo", zh: "撤销" },
  cancelLabel: { en: "Cancel", zh: "取消" },
  restoreLabel: { en: "Restore", zh: "恢复" },
  dayLabel: { en: "Day", zh: "第" },
  daySuffixLabel: { en: "", zh: "天" },
  confirmCancelTitle: { en: "Confirm Cancellation", zh: "确认退票" },
  confirmRestoreTitle: { en: "Confirm Restore", zh: "确认恢复" },
  aboutToCancel: { en: "{name} will be removed.", zh: "{name} 将被取消。" },
  aboutToRestore: { en: "{name} will be restored.", zh: "{name} 将被恢复。" },
